Module DebugServer
    ...
    Dim WhichComponent As String = "Server"
    Dim s As Object = New VisualMonkey.BackupHistory.Server.Service.MainService
    ...
    Sub Main()
        ...
        Console.WriteLine(String.Concat("The ", WhichComponent, " is currently stopped"))
